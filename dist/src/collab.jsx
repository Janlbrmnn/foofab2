...
const Collab = () => {
  ...
  return (
    <div style={{ padding: '80px 32px 48px', maxWidth: 1440, margin: '0 auto' }}>
      <div style={{ paddingBottom: 20, borderBottom: '1px solid var(--line)', marginBottom: 32 }}>
      ...
      {/* toggle */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', border: '1px solid var(--line)', marginBottom: 24 }}>
